...
define(function (require) {
    ...
    var Lazy = lib.newClass(/** @lends module:Lazy.prototype*/{
        ...
        initialize: function () {
            ...
            this.scrollEvent = 'scroll.' + this.tag;
            this.resizeEvent = 'resize.' + this.tag;
        ...
        add: function (el, callback, options) {
            ...
            if (!this.els[guid]) {
                ...
                if (!this.count) {
                    $(window).on(this.scrollEvent, this._bound.onScroll);
                    $(window).on(this.resizeEvent, this._bound.onScroll);
                }
                this.count++;
            }
        ...
        remove: function (el) {
            ...
            if (guid in this.els) {
                ...
                this.count--;
                if (!this.count) {
                    $(window).off(this.scrollEvent, this.onScroll);
                    $(window).off(this.resizeEvent, this.onScroll);
                }
            }
            return this;
        }
